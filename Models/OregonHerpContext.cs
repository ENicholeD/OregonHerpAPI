        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<HerpList>().HasData(
                ...
                new HerpList
                {
                    ...
                    Description = "The dorsal region ranges from brow to greenish brown, with a yellow belly.",
                    Habitat = "Small, clear, freshwater streams ranging from 13°C - 5.8°C with an aproximate ph of 7.6. They have also been found under dense canopies in substrate.",
                    Size= "4-6.2 cm",
                    Diet = "Amphipods, springtails, spiders.",
                    Lifespan = "10 years",
                    ConservationStatus = "Least Concern",
                    Predators = "Pacific giant salamanders, garter snakes, salmonid fish",
                    InvasiveStatus = false
                },
                 new HerpList
                {
                    ...
                    Classification = "Salamander",
                    PhotoPath = "../wwwroot/uploads/Rough-skinned_newt.jpg",
                    Description = "Granular skin ranging from grey-brown to reddish brown with, with a yellow or orange belly. They have a yellow stripe on their upper eyelids, black stripes on the lower eyelids.",
                    Habitat = "",
                    Size= "20 cm",
                    Diet = "",
                    Lifespan = "",
